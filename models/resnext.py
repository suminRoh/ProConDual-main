...
class ProConDual(nn.Module):
    def __init__(self, num_classes=1000, name='resnext50', head='mlp', use_norm=True, feat_dim=1024):
        super(ProConDual, self).__init__()
        ...
        self.head_fc = nn.Linear(dim_in, feat_dim)
    ...
    def forward(self, x):
        ...
        return feat_mlp, logits, centers_logits, self.fc.weight
