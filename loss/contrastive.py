""" 
Blanced contrastive loss in Balnced Contrastive learning:
    https://github.com/FlamieZhu/Balanced-Contrastive-Learning/blob/main/loss/contrastive.py
...
class CL(nn.Module):
    ...
    def forward(self, centers1, features, targets, ):
        ...
        targets = torch.cat([targets.repeat(2, 1), targets_centers], dim=0).cpu()
